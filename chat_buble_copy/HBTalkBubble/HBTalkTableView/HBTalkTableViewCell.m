...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _cellContent.backgroundColor = [UIColor orangeColor];
...
{
    [_mLogo setImageWithURL:url1 layout:UIImageViewLayoutNone placeholderImage:[UIImage imageNamed:@"people.png"]];
}
